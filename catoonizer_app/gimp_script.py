...
from gimp_affine_transformations import *
...
#    pdb.gimp_brightness_contrast(pdb.gimp_image_get_active_layer(image), 70, 30)
    ...
    pdb.gimp_file_save(image, image.layers[0], 'gimp_resources/eyes.png', 'gimp_resources/eyes.png')
    pdb.gimp_image_delete(image)
...
def add_ears(ears_image_file, face_image_file, shape):
    ...
    pdb.gimp_file_save(ears_image, layer, 'gimp_resources/head_with_ears.png', 'gimp_resources/head_with_ears.png')
...
def add_body(body_image_file, head_image_file, shape):
    ...
    stroke(body_image, right_eyebrow_path(new_shape), (255, 255, 255), 3, 80)
